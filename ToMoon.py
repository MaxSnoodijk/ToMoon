...
class Main(ShowBase):
    ...
    def update_physics(self, task):
        ...
        if dt < 1:
            ...
            Physics.time_entry = int(np.floor(Physics.time_simulation / Data.time_step))

            time_check = int(np.floor(Physics.time_simulation))
            ...
            if Triggers.reverse and not Triggers.alignment:
                ...
                if Triggers.alignment_auto:
                    ...
                    Satellite.angle_yaw = (np.arctan((Satellite.vy - Moon.vy) /
                                                     (Satellite.vx - Moon.vx))) * (180 / np.pi) - 180
            ...
            if self.text4_trigger:
                if Triggers.transfer_1:
                    self.text4.setText("Trajectory information" + "\n" + "\n" + "Velocity  (m/s):  "
                                       ...
                                       + "\n" + 'Transfer 1  (%):  '
                                       + str(round(((Physics.time_simulation - Data.time[0]) /
                                                    (Data.time[1] - Data.time[0])) * 100)))
                    ...
                    self.text4.setText("Trajectory information" + "\n" + "\n" + "Velocity  (m/s):  "
                                       ...
                                       + 'Distance to Moon  (km):  ' + str(round((Moon.d_sat - Moon.r) / 10 ** 3))
                                       + "\n" + 'Transfer 2  (%):  '
                                       + str(round(((Physics.time_simulation - Data.time[1]) /
                                                    (Data.time[2] - Data.time[1])) * 100)))
    ...
    def update_phase_2(self, phase, task):
        ...
        if phase == 1:
            if Triggers.phase_1:
                ...
                start_time_stringer = str(round((Trajectory.launch_1_time - Physics.time_simulation) /
                                                Trajectory.time_factor))
            ...
            if Physics.time_simulation < (Trajectory.launch_1_time -
                                          (Trajectory.launch_1_time_sound_start * Trajectory.time_factor)):
                Triggers.sound_launch = True

            if Physics.time_simulation > (Trajectory.launch_1_time -
                                          (Trajectory.launch_1_time_sound_start * Trajectory.time_factor)) \
                    and Triggers.sound_launch:
            ...
            if Physics.time_simulation > (Trajectory.launch_1_time -
                                          (self.phase_1_total_text_time * Trajectory.time_factor)):
            ...
            if Physics.time_simulation >= (Trajectory.launch_1_time +
                                           (Trajectory.launch_1_time_difference * Trajectory.time_factor)):
        ...
        if phase == 3:
            ...
            if Physics.time_simulation > Physics.time_skip and Triggers.time:
                ...
                text_list = list("Simulation speed up disabled, the module has now completed 98% of the first "
                                 "transfer _")
            ...
            if self.text_counter < len(self.phase_3_list) and Physics.time_simulation > Physics.time_skip:
        ...
        if phase == 5:
            if Triggers.phase_5:
                ...
                start_time_stringer = str(round((Trajectory.launch_2_time - Physics.time_simulation) /
                                                Trajectory.time_factor))
            ...
            if Triggers.sound:
                ...
                if Physics.time_simulation > (Physics.time_skip +
                                              (Trajectory.time_factor * (self.sound_background_1_length + 30))):

                    # Time before second launch song

                    if Physics.time_simulation < (Trajectory.launch_2_time -
                                                  (Trajectory.time_factor * (Trajectory.launch_2_time_sound_start +
                                                                             self.sound_background_2_length + 30))):
                        self.sound_background_2.play()

                        Triggers.sound = False

            if Physics.time_simulation < (Trajectory.launch_2_time -
                                          (Trajectory.launch_2_time_sound_start * Trajectory.time_factor)):
                Triggers.sound_launch = True
            ...
            if Physics.time_simulation > (Trajectory.launch_2_time -
                                          (self.phase_5_total_text_time * Trajectory.time_factor)):
            ...
            if Physics.time_simulation > (Trajectory.launch_2_time +
                                          (Trajectory.launch_2_time_difference * Trajectory.time_factor)):
        ...
        if phase == 8:
            if Triggers.phase_8:
                ...
                start_time_stringer = str(round((Trajectory.launch_3_time - Physics.time_simulation) /
                                                Trajectory.time_factor))
            ...
            if Physics.time_simulation > (Trajectory.launch_3_time -
                                          (10 * (Trajectory.launch_3_time_sound_start + 30))) and Triggers.time:
                Trajectory.time_factor = 10

                text_list = list("Simulation speed up disabled, the module has now completed 70% of the second "
                                 "transfer and is close to the final delta-V maneuver _")
                text_time = self.text_display_time + len(text_list) * self.symbol_speed
            ...
            if not Triggers.time:
                ...
                if Physics.time_simulation < (Trajectory.launch_3_time -
                                              (Trajectory.time_factor * Trajectory.launch_3_time_sound_start)):
                    Triggers.sound_launch = True
                ...
                if Physics.time_simulation > (Trajectory.launch_3_time -
                                              (Trajectory.time_factor * self.phase_8_total_text_time)):
                ...
                if Physics.time_simulation >= (Trajectory.launch_3_time +
                                               (Trajectory.time_factor * Trajectory.launch_3_time_difference)):
        ...
        if phase == 9:
            ...
            if Physics.time_simulation > (Trajectory.launch_3_time + (Trajectory.time_factor *
                                                                      (Trajectory.launch_3_time_difference + self.sound_background_3_length + 15))) \
                    and not Triggers.completed:

                text_list = list("Thank you for using the program, I hope you enjoyed it!  The simulation will stop "
                                 "automatically after two orbits and you can exit before at any time _")
    ...
    def update_warnings(self, task):
        ...
        if Triggers.phase_0 and Physics.time_simulation > 0.75 * Data.time[0]:
            ...
            print("\n Simulation terminated due to user inactivity \n")
        ...
        if Triggers.phase_sub:
            if phase == 1:
                ...
                if Physics.time_simulation > (Data.time[0] - (Trajectory.time_factor *
                                                              (2 * self.phase_1_total_text_time))):
                    self.failure_trigger = True

                if Physics.time_simulation > (Data.time[0] - (Trajectory.time_factor *
                                                              ((2 * self.phase_1_total_text_time) + 12))) \
                        and self.major_trigger:
                ...
                elif Physics.time_simulation > (Data.time[0] - (Trajectory.time_factor *
                                                                ((2 * self.phase_1_total_text_time) + 30))) \
                        and self.minor_trigger:
            ...
            if phase == 3:
                ...
                if Physics.time_simulation > (Data.time[0] + (Trajectory.time_factor *
                                                              ((2 * self.phase_2_total_text_time) + Trajectory.launch_1_time_difference + 60))):
                    self.failure_trigger = True

                if Physics.time_simulation > (Data.time[0] + (Trajectory.time_factor *
                                                              ((2 * self.phase_2_total_text_time) + Trajectory.launch_1_time_difference + 48))) \
                        and self.major_trigger:
                    ...
                    self.major_trigger = False
                                                                ...
                                                                ((2 * self.phase_2_total_text_time) + Trajectory.launch_1_time_difference + 30))) \
                        and self.minor_trigger:
            ...
            if phase == 4:
                ...
                if Physics.time_simulation > (Physics.time_skip + (Trajectory.time_factor *
                                                                   ((2 * self.phase_3_total_text_time) + 60))):
                    self.failure_trigger = True

                if Physics.time_simulation > (Physics.time_skip + (Trajectory.time_factor *
                                                                   ((2 * self.phase_3_total_text_time) + 48))) \
                        and self.major_trigger:
                ...
                elif Physics.time_simulation > (Physics.time_skip + (Trajectory.time_factor *
                                                                     ((2 * self.phase_3_total_text_time) + 30))) \
                        and self.minor_trigger:
            ...
            if phase == 5:
                ...
                if Physics.time_simulation > (Data.time[1] - (Trajectory.time_factor *
                                                              (2 * self.phase_5_total_text_time))):
                    self.failure_trigger = True

                if Physics.time_simulation > (Data.time[1] - (Trajectory.time_factor *
                                                              ((2 * self.phase_5_total_text_time) + 12))) \
                        and self.major_trigger:
                ...
                elif Physics.time_simulation > (Data.time[1] - (Trajectory.time_factor *
                                                                ((2 * self.phase_5_total_text_time) + 30))) \
                        and self.minor_trigger:
            ...
            if phase == 7:
                ...
                if Physics.time_simulation > (Data.time[1] + (Trajectory.time_factor *
                                                              ((2 * self.phase_6_total_text_time) + Trajectory.launch_1_time_difference + 60))):
                    self.failure_trigger = True

                if Physics.time_simulation > (Data.time[1] + (Trajectory.time_factor *
                                                              ((2 * self.phase_6_total_text_time) + Trajectory.launch_1_time_difference + 48))) \
                        and self.major_trigger:
                    ...
                    self.major_trigger = False
                                                                ...
                                                                ((2 * self.phase_6_total_text_time) + Trajectory.launch_1_time_difference + 30))) \
                        and self.minor_trigger:
            ...
            if phase == 8:
                ...
                if Physics.time_simulation > (Data.time[1] + (10 * ((2 * (self.phase_6_total_text_time + self.phase_7_total_text_time)) + Trajectory.launch_1_time_difference + 234))) \
                        and self.major_trigger:
                ...
                elif Physics.time_simulation > (Data.time[1] + (10 * ((2 * (self.phase_6_total_text_time + self.phase_7_total_text_time)) + Trajectory.launch_1_time_difference + 180))) \
                        and self.minor_trigger:
    ...
    def __init__(self):
        ...
        self.accept("c", lambda: self.update_menus('controls', True) if not self.text2_trigger else self.update_menus('controls', False))
        ...
        self.accept("t", lambda: self.update_menus('trajectory', True) if not self.text4_trigger else self.update_menus('trajectory', False))
        ...
        self.phase_2_text = [list("Delta-V maneuver completed, main engine shut down _"),
                             ...
                             list("You can skip the major part of the first transfer, bringing the module close to the "
                                  "second transfer around the Moon _"),
                             list("In this scenario both corrective burns will be completed and all that remains is "
                                  "the attitude change before the second transfer _"),
                             list("Or you can speed up the simulation, allowing you to travel 30 times faster _"),
                             list("It will then take approximately 20 minutes to complete the first transfer and you "
                                  "get to enjoy the view _")]
        ...
        self.phase_6_text = [list("Second delta-V maneuver completed, main engine shut down _"),
                             ...
                             list("The simulation can be sped up to 3 times the current speed, "
                                  "reducing the transfer time to a mere 6 minutes _")]
        ...
        self.phase_7_text = [list("Simulation speed up enabled _"),
                             list("The final delta-V maneuver is about 5 minutes away at this simulation rate and it "
                                  "is required that you arm the module's thruster one last time _")]
        ...
        self.phase_9_total_text_time = sum(self.phase_9_text_time)
